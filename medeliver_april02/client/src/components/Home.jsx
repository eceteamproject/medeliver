...
function Home() {
  return (
    <div>
      ...
      <div class="row">
        <img class="column" className="points" alt="" src={deliveryMan} />
        <img class="column" className="points" alt="" src={pharmacyStore} />
        <img class="column" className="points" alt="" src={pill} />
      </div>
